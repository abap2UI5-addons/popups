...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory_empty.
    ...
    DATA(lo_pop) = z2ui5_cl_popup_get_range=>factory( ).
  ...
  METHOD test_factory_w_range.
    ...
    DATA(lt_range) = VALUE z2ui5_cl_popup_context=>ty_t_range(
      ( sign = `I` option = `EQ` low = `100` ) ).

    DATA(lo_pop) = z2ui5_cl_popup_get_range=>factory( lt_range ).
...
CLASS ltcl_test_roundtrip DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS popup_create
      RETURNING
        VALUE(ro_pop) TYPE REF TO z2ui5_cl_popup_get_range.
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD popup_create.
    ...
    ro_pop = z2ui5_cl_popup_get_range=>factory( ).
