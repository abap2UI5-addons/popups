...
CLASS z2ui5_cl_popup_to_confirm DEFINITION LOCAL FRIENDS ltcl_test ltcl_test_events.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_constants.
    ...
    cl_abap_unit_assert=>assert_not_initial( z2ui5_cl_popup_to_confirm=>cs_event-confirmed ).
    cl_abap_unit_assert=>assert_not_initial( z2ui5_cl_popup_to_confirm=>cs_event-canceled ).
...
CLASS ltcl_test_events IMPLEMENTATION.
  ...
  METHOD test_default_events_differ.
    ...
    cl_abap_unit_assert=>assert_differs(
      act = z2ui5_cl_popup_to_confirm=>cs_event-confirmed
      exp = z2ui5_cl_popup_to_confirm=>cs_event-canceled ).
