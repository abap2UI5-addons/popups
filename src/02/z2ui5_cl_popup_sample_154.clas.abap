  ...
  METHOD on_event.
    ...
    CASE client->get( )-event.
      ...
      WHEN `POPUP_BALLOG`.
        ...
        lt_bal = VALUE #(
          ( msgid = `MSG1` msgno = `001` msgty = `S` time_stmp = z2ui5_cl_popup_context=>time_get_timestampl( ) msgnumber = `01` )
          ( msgid = `MSG2` msgno = `002` msgty = `S` time_stmp = z2ui5_cl_popup_context=>time_get_timestampl( ) msgnumber = `02` ) ).
