...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_pop) = z2ui5_cl_popup_demo_output=>factory( NEW ltcl_output_stub( ) ).
  ...
  METHOD test_factory_custom.
    ...
    DATA(lo_pop) = z2ui5_cl_popup_demo_output=>factory(
...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_popup.
    ...
    DATA(lo_pop) = z2ui5_cl_popup_demo_output=>factory( i_output = NEW z2ui5_cx_abap2ui5_error( `x` )
                                                      i_title  = `Demo Title` ).
  ...
  METHOD test_toggle_fullscreen.
    ...
    DATA(lo_pop) = z2ui5_cl_popup_demo_output=>factory( NEW z2ui5_cx_abap2ui5_error( `x` ) ).
